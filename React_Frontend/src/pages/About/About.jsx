...
//           <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl font-semibold text-textPrimary mb-4">
//             CardioRisk AI
//           </motion.h1>

//           <motion.p variants={fadeUp} className="text-lg text-textSecondary leading-relaxed">
...
//           className="relative"
//         >
//           <motion.h2 variants={fadeUp} className="text-3xl font-semibold text-textPrimary mb-3">
//             Stack Architecture
//           </motion.h2>

//           <motion.p variants={fadeUp} className="text-textSecondary max-w-3xl mb-10">
...
//               title="AI & Backend"
//               items={[
//                 { title: "Python & Scikit-Learn", desc: "Model training, preprocessing, and evaluation." },
//                 { title: "Random Forest Classifier", desc: "Captures non-linear cardiovascular risk patterns." },
//                 { title: "FastAPI Inference Layer", desc: "Real-time prediction and metrics API." },
//               ]}
//             />
...
//               className="hidden md:flex absolute left-1/2 -translate-x-1/2 gap-2 text-primary"
//             >
//               <ArrowRight />
//               <ArrowRight />
//               <ArrowRight />
...
//               items={[
//                 { title: "React + Vite", desc: "Fast, modular frontend architecture." },
//                 { title: "Tailwind + Framer Motion", desc: "Clean UI with motion-driven feedback." },
//                 { title: "Cloud Deployment", desc: "Scalable, production-ready hosting." },
//               ]}
//             />
//           </div>
//         </motion.section>
...
//           className="max-w-5xl"
//         >
//           <motion.h2 variants={fadeUp} className="text-3xl font-semibold text-textPrimary mb-10">
...
//               <motion.div variants={fadeUp} className="ml-12 p-5 rounded-xl bg-card border border-borderSubtle">
//                 <p className="text-textSecondary leading-relaxed">
//                   CardioRisk AI identifies these hidden interactions by analyzing
//                   multiple clinical and lifestyle signals together — not in isolation.
//                 </p>
//               </motion.div>
//             </div>
//           </div>
...
//             <ValueCard icon={Eye} title="Interpretability First" desc="Predictions are backed by understandable signals." />
//             <ValueCard icon={ShieldCheck} title="Transparent Evaluation" desc="Metrics are openly presented and validated." />
//             <ValueCard icon={Layers} title="Clear System Separation" desc="AI, data, and UX are independently structured." />
//             <ValueCard icon={Rocket} title="Built for Real Use" desc="Designed and deployed as a real product." />
//           </div>
//         </motion.section>

//         {/* ================= AUTHOR ================= */}
//         <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
//           <div className="flex gap-4 p-5 max-w-3xl rounded-xl bg-card border border-borderSubtle">
//             <div className="p-3 rounded-lg bg-primaryLight">
//               <User className="text-primary" />
//             </div>
//             <div>
//               <p className="text-xs uppercase tracking-wide text-muted mb-1">Project Author</p>
//               <p className="text-lg font-semibold text-textPrimary">Payal Kava</p>
//               <p className="text-textSecondary text-sm mt-1">
//                 Designed and developed as a full-stack AI system focused on transparent
...
//   return (
//     <motion.div variants={fadeUp} className="relative flex gap-4 items-start ml-2">
...
//   return (
//     <motion.div variants={fadeUp} whileHover={{ y: -4 }} className="p-5 rounded-xl bg-card border border-borderSubtle">
